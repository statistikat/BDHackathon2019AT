...
### iLog is an interactive time-diary
...
The geographical distribution of fitness among the EU countries can be displayed 
with the geofacet package. 


The histograms in the plot can easily be replaced by other plot types.
